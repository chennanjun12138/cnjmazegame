...
class cnjmazehard : AppCompatActivity(){
    public var widths = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view_timer.base = SystemClock.elapsedRealtime() + 360000
        view_timer.start()
        ...
        Timer().schedule(object : TimerTask() {
            override fun run() {
                //if (SystemClock.elapsedRealtime()-view_timer.getBase()>=0)view_timer.stop();
                Looper.prepare()
                val builder = AlertDialog.Builder(this@cnjmazehard)
                builder.setTitle("游戏结束")
                builder.setMessage("遗憾，闯关失败!")
                builder.setPositiveButton("确定"){
                        DialogInterface,which->
                    val intent2 = Intent(this@cnjmazehard, cnjgameset::class.java)
        ...
        b1.setOnClickListener {
            ...
            {   mediaPlayer.stop()
                ...
                val ans=jifeng.toString().toInt()+20
